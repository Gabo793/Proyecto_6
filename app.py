...
if hist_button:
    ...
    st.write(
        "Creacion de un histograma para el conjunto de datos de anuncio de ventas de coche")
...
# Configuracion para cuando se seleccionen ambas casillas
elif build_hist and build_scat:

    # Mensaje al seleccionar ambas casillas
    st.write("Creacion de un histograma y un diagrama de dispersion para el conjunto de datos de anuncion de ventas de coches")

    # Se crea un histograma y un diagrama de dispersion
    fig_5 = px.histogram(car_data, x="odometer")
    fig_6 = px.scatter(car_data, x="odometer", y="price")

    # Se muestran los 2 graficos
